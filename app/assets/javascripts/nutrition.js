   ...
   "children": [
    {
     "name": "cluster",
     "children": [
      {"name": "AgglomerativeCluster", "size": 39380000},
...
//
// var svg = d3.select("#dendrogram_drop_down").append("svg")
...
//
// // d3.json("http://bl.ocks.org/mbostock/raw/4063550/flare.json", function(error, dendrogram_data) {
// //   if (error) throw error;
//   var nodes = cluster.nodes(dendrogram_data),
...
//------------------------------------------------------------------------------
// Tree anim on div:  dendrogram_anim
//  also css
//------------------------------------------------------------------------------
...
//
//   var svg = d3.select("#dendrogram_anim").append("svg")
//       .attr("width", width + margin.left + margin.right)
//       .attr("height", height + margin.top + margin.bottom)
...
//
// treeAnimation(
//   {type: "selection", name: "Nutricion", children: [
